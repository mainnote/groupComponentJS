...
define('autocomplete',['jquery', 'input', 'typeahead', 'bloodhound'], function($, Input, typeahead, Bloodhound) {
...
define('formOption',['jquery', 'optObj'], function($, OptObj) {
...
define('inputListGrp',['jquery', 'optGrp', 'inputList', 'listItemGrp', 'collectionGrp', 'Promise'], function($, OptGrp, InputList, ListItemGrp, CollectionGrp, Promise) {
...
define('prompt',['jquery', 'component', 'tpl!templates/prompt', 'scroll'], function($, Component, tpl, Scroll) {
...
define('promptFormGrp',['jquery', 'optGrp', 'prompt', 'formGrp'], function($, OptGrp, Prompt, FormGrp) {
...
define('textareaCountGrp',['jquery', 'optGrp', 'textarea', 'count'], function($, OptGrp, Textarea, Count) {
